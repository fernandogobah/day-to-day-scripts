...
# Desc: Script to renew certificate SSL in Zimbra Mail
...
DOMAINS="-d $DOMAINP --expand -d {LISTA DE DOMÍNIO}"

#Não modificar daqui pra baixo
su - zimbra -c "zmproxyctl stop"
su - zimbra -c "zmmailboxdctl stop"
sudo rm -r /etc/letsencrypt/archive/$DOMAINP*
sudo rm -r /etc/letsencrypt/live/$DOMAINP*
sudo rm -r /etc/letsencrypt/renewal/$DOMAINP*
cd /opt
